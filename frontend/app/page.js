    ...
    <div className="page-enter">
      ...
      <section className="hero-pattern text-white pt-24 pb-28 md:pt-36 md:pb-36 px-4 md:px-8
        ...
        <div className="absolute -top-20 -right-20 w-80 h-80 rounded-full bg-white/5
                        pointer-events-none" />
        <div className="absolute top-1/2 -left-16 w-52 h-52 rounded-full bg-white/4
                        pointer-events-none" />
        <div className="absolute bottom-16 right-1/4 w-24 h-24 rounded-full bg-white/5
                        pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <div className="flex items-center justify-center gap-6 pt-3 text-white/55
                          text-xs font-medium tracking-wide">
            <span className="flex items-center gap-1.5">
              <span className="text-green-300">✓</span> Fast delivery
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-green-300">✓</span> Verified products
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-green-300">✓</span> Secure payment
            </span>
          </div>
        </div>

        {/* Wave bottom — transitions into white Popular Items section */}
      ...
      {/* ── Popular Items ─────────────────────────────────────────────────── */}
      <section className="pt-10 pb-14 px-4 md:px-8 bg-white">
          ...
          <div className="flex items-end justify-between mb-7">
            <div>
              ...
              <p className="text-sm text-text-secondary mt-0.5">
                What students are buying this week
              </p>
            </div>
            <Link href="/products"
                  className="text-primary text-sm font-semibold hover:underline
                             underline-offset-4 shrink-0 flex items-center gap-1">
              See all
      ...
      {/* ── WhatsApp CTA — dark green bookend ─────────────────────────────── */}
        ...
        <div className="max-w-xl mx-auto text-center space-y-5 relative z-10">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-white text-primary font-bold
                       ...
                       hover:bg-white/95 hover:translate-y-[-2px] hover:shadow-xl
